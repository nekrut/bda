...
Genomic data analysis can be represented as a pyramid. Consider an RNA-seq experiment: you receive reads from your sequencing machine, map them, and count how many fall within each gene. This **primary analysis** uses well-established tools and workflow systems, often requiring significant computational infrastructure. The output—count tables for RNA-seq, variant lists for variant calling, or peak coordinates for ChIP-seq—are intermediate datasets. They don't yet contain biological insights.
...
![](images/data-pyramid.svg){width=50% fig-align="center"}

## Spring 2026 | Jan 12 - May 1

| # | Date | Topic | Description |
|---|------|-------|-------------|
| 1 | Jan 14 | [Python 1](lectures/lecture1.ipynb) | |
| 2 | Jan 16 | [Bash, Git](lectures/lecture2.qmd) | |
| 3 | Jan 21 | Python 2 | |
| 4 | Jan 23 | Python 3 | |
| 5 | Jan 28 | Python 4 | |
| 6 | Jan 30 | Sequencing | |
| 7 | Feb 4 | Mapping | |
| 8 | Feb 6 | SAM/BAM | |
| 9 | Feb 11 | Variation I | |
| 10 | Feb 13 | Variation II | |
| 11 | Feb 18 | Genome graphs | |
| 12 | Feb 20 | TBD | |
| 13 | Feb 25 | TBD | |
| 14 | Feb 27 | TBD | |
| 15 | Mar 4 | TBD | |
