...
Bacterial pangenomics originated with Tettelin et al. [2] and has become routine in microbial genomics. The gene-oriented approach remains dominant:

- **Roary** [3]: Fast but sensitive to annotation quality
- **Panaroo** [4]: Corrects annotation errors via a gene neighborhood graph
- **PPanGGOLiN** [5]: Partitions genes into persistent/shell/cloud using Markov Random Fields
