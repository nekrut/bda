...
::: {.callout-important}
## Submission
A Google form for uploading your final PDF summary will be emailed to you separately. **The deadline is the start of next Tuesday's class.** Submit one PDF per student.
:::
...
3. Upload `summary.pdf` to the form linked in the **email I will send separately**. One PDF per student. Use your Penn State email address on the form
