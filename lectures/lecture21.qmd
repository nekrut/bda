...
The choice is not arbitrary. In 1982, Edsger Dijkstra argued in his note [*"Why numbering should start at zero"*](https://www.cs.utexas.edu/~EWD/transcriptions/EWD08xx/EWD831.html) [6] that 0-based half-open intervals are the most natural convention for computing. Two properties make them superior: the length of an interval `[a, b)` is simply `b - a`, and two adjacent intervals `[a, b)` and `[b, c)` share a boundary with no gaps and no overlaps. The BED format adopts exactly this convention. GFF and VCF predate this reasoning or follow biological tradition where "the first base" is base 1.
...
- **[`bx-python`](https://github.com/bxlab/bx-python)**---a Python library for fast interval indexing and manipulation; provides the interval tree and binned array implementations used by Galaxy
...
6. [Dijkstra, E.W. (1982). Why numbering should start at zero. EWD 831.](https://www.cs.utexas.edu/~EWD/transcriptions/EWD08xx/EWD831.html)
