...
[**`data/` on GitHub**](https://github.com/nekrut/bda/tree/main/data)
...
> *Download `assembly1.fasta.gz` through `assembly13.fasta.gz` from `https://github.com/nekrut/bda/tree/main/data` into a local `assemblies/` directory, then gunzip them.*
